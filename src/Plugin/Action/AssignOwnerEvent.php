...
/**
 * Assigns ownership of a event to a user.
 *
 * @Action(
 *   id = "event_assign_owner_action",
 *   label = @Translation("Change the author of event"),
 *   type = "event"
 * )
 */
class AssignOwnerEvent extends ConfigurableActionBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new AssignOwnerEvent action.
   *
  ...
  public function access($object, AccountInterface $account = NULL, $return_as_object = FALSE) {
    /** @var \Drupal\event\EventInterface $object */
