...
/**
 * Tests creating event views with the wizard.
 *
 * @ViewsWizard(
 *   id = "event",
 *   base_table = "event_field_data",
 *   title = @Translation("Content")
 * )
 */
class Event extends WizardPluginBase {
   ...
   * @var string
   */
  protected $createdColumn = 'event_field_data-created';
  ...
  public function getAvailableSorts() {
    ...
    return [
      'event_field_data-title:ASC' => $this->t('Title')
    ];
  }
  ...
  protected function defaultDisplayOptions() {
    ...
    $display_options['fields']['title']['table'] = 'event_field_data';
  ...
  protected  function display_options_row(&$display_options, $row_plugin, $row_options) {
    switch ($row_plugin) {
      case 'full_posts':
        $display_options['row']['type'] = 'entity:event';
