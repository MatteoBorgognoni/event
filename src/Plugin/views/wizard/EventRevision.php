...
namespace Drupal\event\Plugin\views\wizard;
...
/**
 * Tests creating event revision views with the wizard.
 *
 * @ViewsWizard(
 *   id = "event_revision",
 *   base_table = "event_field_revision",
 *   title = @Translation("Content revisions")
 * )
 */
class EventRevision extends WizardPluginBase {
   ...
   *
   * Event revisions do not support full posts or teasers, so remove them.
   */
  ...
  protected function defaultDisplayOptions() {
    ...
    $display_options['fields']['changed']['table'] = 'event_field_revision';
    $display_options['fields']['changed']['field'] = 'changed';
    $display_options['fields']['changed']['entity_type'] = 'event';
    ...
    $display_options['fields']['title']['table'] = 'event_field_revision';
    $display_options['fields']['title']['field'] = 'title';
    $display_options['fields']['title']['entity_type'] = 'event';
