...
/**
 * Defines the translation handler for events.
 */
class EventTranslationHandler extends ContentTranslationHandler {
  ...
  public function entityFormAlter(array &$form, FormStateInterface $form_state, EntityInterface $entity) {
    ...
    if (isset($form['content_translation'])) {
      // We do not need to show these values on event forms: they inherit the
      // basic event property values.
  ...
  protected function entityFormTitle(EntityInterface $entity) {
    $type_name = event_get_type_label($entity);
