 ...
 */
interface EventTypeInterface extends ConfigEntityInterface, RevisionableEntityBundleInterface {

  /**
   * Determines whether the event type is locked.
   *
   * @return string|false
   ...
   *
   * @return string
   *   The help information of this event type.
   */
